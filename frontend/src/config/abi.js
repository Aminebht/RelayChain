export const RELAY_ABI = [
  ...
  "function parcels(uint256) view returns (address sender,address recipient,address carrier,uint256 price,string pickupLocation,string dropoffLocation,uint8 status,uint256 createdAt,uint256 lastActionAt)",
  ...
  "function postParcel(address recipient,uint256 price,string pickupLocation,string dropoffLocation) returns (uint256)",
  "function payForParcel(uint256 parcelId) payable",
  "function acceptParcel(uint256 parcelId)",
  ...
  "function triggerTimeout(uint256 parcelId)",
